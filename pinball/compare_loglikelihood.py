...
if IS_KAGGLE:
    ...
    CHECKPOINT_PATHS = {
        ...
        "anp_mu": SCRIPT_DIR / "checkpoints_pinball_no_dndec_mu_new_5sens/phase2/best_model.pt",
        "anp_no_mu": SCRIPT_DIR / "checkpoints_pinball_no_dndec_no_mu_new_5sens/phase2/best_model.pt",
        "lnp_mu": SCRIPT_DIR / "checkpoints_pinball_no_dndec_mu_3/phase2/best_model.pt",
        "lnp_no_mu": SCRIPT_DIR / "checkpoints_pinball_no_dndec_no_mu_3/phase2/best_model.pt",
...
def plot_all_distributions(ll_dict, se_dict, sse_dict, mse_dict, out_path, bins=80, clip_pct=0.5):
    print_diagnostic_summary({
        "Log likelihood": ll_dict,
        "Standardized squared error": sse_dict,
