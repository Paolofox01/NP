...
def main() -> None:
    print("[GoPro ANP] Starting training script...")
    data_dir = Path(__file__).resolve().parent
    checkpoints = data_dir / "checkpoints_gopro_anp"
    ...
    print("[GoPro ANP] Initializing model...")
    model = LatNP(
    ...
    train_np(
        ...
        early_stopping_patience=500, is_meta_learning=True, verbose=True, print_every=10,
